...
knitr::kable(state_loca_02, digits = 1)
```

| locationabbr | distinct\_loca |
| :----------- | -------------: |
| CT           |              7 |
| FL           |              7 |
| MA           |              8 |
...
state_loca_10 = brfss %>% 
  ...
  summarize(distinct_loca = n_distinct(locationdesc)) %>%
  filter (distinct_loca >= 7) 
knitr::kable(state_loca_10, digits = 1)
```
...
| TX              |                                                                                                                                                                                         16 |
| WA              |                                                                                                                                                                                         10 |
| The states that | were observed at 7 or more locations are: CT, FL, MA, NC, NJ, PA. The states that are observed at 7 or more locations at 2010 are: CA, CO, FL, MA, MD, NC, NE, NJ, NY, OH, PA, SC, TX, WA. |
